import 'package:aquafitapp/IMC/input_page/input_page_styles.dart';
import 'package:aquafitapp/IMC/model/gender.dart';
import 'package:flutter/material.dart';
import '../app_bar.dart';
import 'package:aquafitapp/IMC/calculator.dart' as calculator;
        ...
        children: <Widget>[
          Padding(
            ...
            child: IconButton(
              ...
              onPressed: () => Navigator.of(context).pushReplacementNamed('/imc'),
            ),
          ),
          Container(
              height: 52.0,
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            Text(
              'IMC = ${bmi.toStringAsFixed(2)} kg/m²',
              style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w700),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 16.0),
              child: Text(
                'Rango de peso de IMC normal para la altura:\n${minWeight.round()}kg - ${maxWeight.round()}kg',
